...
public class AESEncryptor
{
    ...
    public static Task<bool> FileDecryptAsync(string inputFile, string outputFile, string password)
    {   
    ...
    /// <param name="inputFile"></param>
    /// <param name="password"></param>
    private static void FileEncryptPrivate(string inputFile, string password)
    {
